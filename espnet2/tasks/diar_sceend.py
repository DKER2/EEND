...
from espnet2.diar.SC_EEND import SC_EEND
...
class SC_EENDTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            default=get_default_kwargs(SC_EEND),
    ...
    @classmethod
    def build_model(cls, args: argparse.Namespace) -> SC_EEND:
        assert check_argument_types()
